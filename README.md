...
## Strings
The guide [prefers `'` over `"`][strings]. We only require that quotes are used consistently within the file. This will be [enforced by jshint](http://www.jshint.com/docs/options/#quotmark).

[strings]: https://google.github.io/styleguide/jsguide.html#features-string-literals
